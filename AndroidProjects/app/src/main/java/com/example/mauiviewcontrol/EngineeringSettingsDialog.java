...
public class EngineeringSettingsDialog extends Dialog{
    ...
    private void setUpWidgetsInGeneralPage() {
        try {
            ...
            WidgetUtility.setUpFloatingActionButtonListener(mContext, mFragmentGeneral.findViewById(R.id.tx3PlusFloatingActionButton), new IncrementTx3Apertures(), backEndElementSendingMessageVisitor, true, "Increment TX 3 Apertures: ");
            WidgetUtility.setUpFloatingActionButtonListener(mContext, mFragmentGeneral.findViewById(R.id.tx3MinusFloatingActionButton), new DecrementTx3Apertures(), backEndElementSendingMessageVisitor, true, "Decrement TX 3 Apertures: ");
    ...
    public void checkRealtimeStates() {
        ...
        try {
            ...
            float min = defaultValue - Float.valueOf(strings[1]) / 2;
            float max = defaultValue + Float.valueOf(strings[1]) / 2;
            MauiSlider.setUpSliderListener(mContext, null, mDialog, new FineAdjust(), mBackEndSliderElementSendingMessageVisitor, true, "Frequency value updated", min, max, ParameterLimits.FloatValueStep, mDialog.findViewById(R.id.fineAdjustInEngineeringGeneralSeekBar));
            MauiSlider.setCurrentSliderPosition(mFragmentGeneral.findViewById(R.id.fineAdjustInEngineeringGeneralSeekBar), mBackend.getTxFreq(), min, max, ParameterLimits.FloatValueStep);
