...
public class EngineeringDialog {
    ...
    private void setUpWidgetsInGeneralPage() {
        try {
            ...
            WidgetUtility.setUpFloatingActionButtonListener(mContext, mDialog.findViewById(R.id.tx3PlusFloatingActionButton), new IncrementTx3Apertures(), backEndElementSendingMessageVisitor, true, "Increment TX 3 Apertures: ");
            WidgetUtility.setUpFloatingActionButtonListener(mContext, mDialog.findViewById(R.id.tx3MinusFloatingActionButton), new DecrementTx3Apertures(), backEndElementSendingMessageVisitor, true, "Decrement TX 3 Apertures: ");
    ...
    public void checkRealtimeStates() {
        ...
        try {
            ...
            MauiSlider.setCurrentSliderPosition(mDialog.findViewById(R.id.fineAdjustInEngineeringGeneralSeekBar), mBackend.getTxFreq(), min, max, ParameterLimits.FloatValueStep);
